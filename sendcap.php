        ...
        $dom->load_html("<!DOCTYPE html> <html><head>
                ...
                *{font-family:Arial,Helvetica,sans-serif; text-size-adjust: auto;}
                ...
                li, ul, p{font-size:16px;line-height: 0.5}
                    ...
                    <ul>
                    <li>
                    <p> Aba > ".$corAbaFrenteFL_0."</p>
                    </ul>
                    </li>
                    <ul>
                    <li>
                    <p> Frente > ".$corAbaFrenteFL_1."</p>
                    </ul>
                    </li>
                    <ul>
                    <li>
                    <p> Fundo e Lateral > ".$corAbaFrenteFL_2."</p>
                    </ul>
                    </li>
                    <h2>Aplicação da logomarca</h2>
                    <ul>
                    <li>
                    <p>".$apllogo."</p>
                    </ul>
